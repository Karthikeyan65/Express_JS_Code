...
router.post('/', async (req, res) => {
  try {
    ...
    await client.query("INSERT INTO users(id, name, email, password, age, address) VALUES ($1, $2, $3, $4, $5, $6)", [id, name, email,  encryptedPassword, age, address]);
    res.status(201).json({ message: "User created successfully", user: { id, name, email, age, address } });
  } catch (error) {
